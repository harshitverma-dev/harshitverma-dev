...
- I have developed many frontend web applications using JavaScript, React.js, Redux.js and familiar with nodeJS ExpressJS, MongoDB and API development.       
  skills : JavaScript, React.js, Redux.js, API Integration, JSON, Next.js, React-Bootstrap 
